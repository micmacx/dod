...
public OnPluginStart()
{
	...
	HitInfoStatus = CreateConVar("dod_hitinfo_status", "1", "<1/0> = enable/disable HitInfo messages", FCVAR_PLUGIN, true, 0.0, true, 1.0)
	HitInfoDistUnit = CreateConVar("dod_hitinfo_distunit", "2", "<1/2> = unit to display distances  -  1 = feet  -  2 = meters", FCVAR_PLUGIN, true, 1.0, true, 2.0)
	HitInfoDispHeadshot = CreateConVar("dod_hitinfo_headshotannounce", "1", "<1/0> = enable/disable Headshot Announcements", FCVAR_PLUGIN, true, 0.0, true, 1.0)
	HitInfoSoundHeadshot = CreateConVar("dod_hitinfo_headshotsound", "0", "<1/0> = enable/disable Headshot Sound", FCVAR_PLUGIN, true, 0.0, true, 1.0)
