...
public void OnPluginStart()
{
	...
	g_Cvar_StartTime = CreateConVar("sm_mapvote_start", "1.0", "Specifies when to start the vote based on time remaining.", _, true, 1.0);
	g_Cvar_StartRounds = CreateConVar("sm_mapvote_startround", "0.0", "Specifies when to start the vote based on rounds remaining. Use 0 on TF2 to start vote during bonus round time", _, true, 0.0);
